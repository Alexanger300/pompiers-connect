    ...
    <div className="mobile-shell bg-background">
      ...
      <main className={isAuthenticated ? 'pb-20' : ''}>
        <Routes>
          ...
          <Route path="/competences" element={<ProtectedRoute roles={['agent']}><Skills /></ProtectedRoute>} />
          ...
          <Route path="/admin/suivi" element={<ProtectedRoute roles={['admin', 'superviseur']}><AdminTraining /></ProtectedRoute>} />
